...
class Calculator(Frame):
    ...
    def __init__(self):
        ...
        Label(self, text="No. of Entries:", font=4, bg="lightgray").grid(row=0, column=0, sticky=W, pady=2)
        Label(self, text="No. of Vectors:", font=4, bg="lightgray").grid(row=1, column=0, sticky=W, pady=2)
        ...
        Button(self, text="Calculate", width=15, bg='steel blue', fg='white', command=lambda: self.calculate()).grid(row=2, column=1, sticky=W, pady=2, padx=2)
    ...
    def displayResult(self, result):
        ...
        # Display the result.
        self.resultLabel = Label(self, text=s[:-1], font=4, bg="steel blue")
        self.resultLabel.grid(row=3, column=0, columnspan=2, sticky=N)
